  ...
  if (isloading) {
    return (
      <div className="flex flex-col items-center justify-center py-24 gap-4">
        ...
        <p className="text-muted-foreground font-medium animate-pulse">Syncing taxonomies...</p>
      </div>
    );
  }
  ...
  if (!data || data.length === 0) {
    return (
      <div className="text-center py-24 bg-muted/20 rounded-[2rem] border border-dashed border-border">
        <Layers className="size-12 text-muted-foreground opacity-20 mx-auto mb-4" />
        <h1 className="text-muted-foreground font-bold text-xl">No categories found</h1>
        <p className="text-muted-foreground/60 text-sm mt-2">Create a category to start organizing content.</p>
      </div>
    );
  }
            ...
            >
              ...
              <td className="px-6 py-5">
                <div className="flex items-center gap-3">
                  <div className="size-9 rounded-xl bg-muted border border-border flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-all shadow-sm">
              ...
              <td className="px-6 py-5">
                <div className="flex items-center gap-2 text-[11px] text-muted-foreground/80 bg-muted/50 w-fit px-3 py-1.5 rounded-lg border border-border font-mono group-hover:border-primary/20 transition-all font-medium">
                  <Link2 className="size-3 text-muted-foreground/40 group-hover:text-primary/70" />
                  {item?.slug}
                </div>
              </td>
