...
//         <h1 className="font-bold p-6">authors</h1>
    ...
    <main className="min-h-screen w-full flex flex-col gap-8 bg-[#0a0a0c] p-6 lg:p-10 text-slate-200">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white tracking-tight">Author Registry</h1>
            <p className="text-sm text-slate-500 mt-1">
              Manage team members and content contributors
            </p>
          </div>
        </div>
      ...
      {/* Overview Stat Card */}
      <div className="max-w-xs p-5 rounded-[1.5rem] bg-slate-900/40 border border-white/5 flex flex-col gap-1">
        <span className="text-[10px] font-bold uppercase tracking-widest text-slate-500 flex items-center gap-2">
          <Users className="size-3 text-emerald-500" /> Active Writers
        </span>
      ...
      <section className="bg-slate-900/20 border border-white/5 rounded-[2.5rem] overflow-hidden shadow-xl">
        <div className="p-6 border-b border-white/5 bg-white/[0.02] flex items-center justify-between">
          <h2 className="text-sm font-bold uppercase tracking-widest text-slate-400">Contributor List</h2>
          <Button variant="ghost" size="sm" className="text-xs text-slate-500 gap-2 hover:bg-emerald-500/10">
            <ListFilter className="size-3" /> Sort A-Z
          </Button>
        </div>
