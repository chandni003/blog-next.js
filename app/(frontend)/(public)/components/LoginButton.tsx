            ...
            {role === "admin" ? (
              <Link href="/admin/dashboard">
                <DropdownMenuItem className="cursor-pointer gap-3 py-3 px-4 rounded-2xl focus:bg-primary focus:text-primary-foreground group transition-all">
                  ...
                  <span className="font-bold text-xs uppercase tracking-widest">Admin Control Panel</span>
                </DropdownMenuItem>
              </Link>
            ) : (
              <Link href="/dashboard">
                <DropdownMenuItem className="cursor-pointer gap-3 py-3 px-4 rounded-2xl focus:bg-primary focus:text-primary-foreground group transition-all">
                  <LayoutDashboard className="h-4 w-4 opacity-70 group-hover:opacity-100" />
                  <span className="font-bold text-xs uppercase tracking-widest">Writer Dashboard</span>
                </DropdownMenuItem>
              </Link>
            )}
          </DropdownMenuGroup>
            ...
            {role === "admin" && (
              <Link href="/admin/categories">
                <DropdownMenuItem className="cursor-pointer gap-3 py-3 px-4 rounded-2xl hover:bg-primary/5 focus:bg-primary/10 text-foreground/80 focus:text-primary transition-all">
                  ...
                  <span className="font-bold text-xs uppercase tracking-wider text-muted-foreground group-hover:text-primary">Manage Taxonomies</span>
                </DropdownMenuItem>
              </Link>
            )}
